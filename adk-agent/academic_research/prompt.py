...
After finishing the web search, ask if the user needs help brainstorming new research directions. Or assume they want to if they have explictly asked for new ideas instead of web search.
If so, you can suggest Future Research Directions (Using academic_newresearch):
