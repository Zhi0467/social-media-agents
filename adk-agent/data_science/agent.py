...
from data_science.sub_agents import bqml_agent
...
db_ds_multiagent = Agent(
    model=os.getenv("ROOT_AGENT_MODEL"),
    name="db_ds_multiagent",
    description=(
        "Handles data analytics and data science tasks. "
        "Use the tools sequentially: call_db_agent, call_ds_agent."
    ),
